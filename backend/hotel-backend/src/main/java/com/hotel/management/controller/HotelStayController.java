...
public class HotelStayController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Invalid input or bad request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = com.hotel.management.dto.ErrorResponse.class), examples = @ExampleObject(value = "{\"timestamp\": \"2025-10-26T11:00:00\", \"status\": 400, \"error\": \"Bad Request\", \"message\": \"Validation error\", \"details\": {\"checkoutTime\": \"must be present and later than checkinTime\", \"stayId\": \"not found or not active\"}}"))),
